...
public class CompteComptableTest {
    ...
    public void testConstruteurWithoutParameters(){
        ...
        compteComptable.setNumero(numeroCompteCompatble);
        compteComptable.setLibelle(libelleCompteComptable);
    ...
    @Test
    public void testConstruteurWithNumereCompte(){
        //Arrange
        Integer numeroCompteCompatble = 1;
        String libelleCompteComptable = "test constructeur";

        //Act
        CompteComptable compteComptable = new CompteComptable(numeroCompteCompatble);
        compteComptable.setLibelle(libelleCompteComptable);
